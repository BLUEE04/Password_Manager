...
int main()
{
    ...
    pw->txtOutput(hConsole, 14, true, "| Version 1.5                                      |");
    ...
    while (true) {
        ...
        if (!cin.fail()) {
            ...
            cout << "ERROR; Please use the menu with appropriate payment entries!" << endl;
            cin.clear();
            cin.sync();
        }
                ...
                if (liste->suche(website) == -1) {
                    ...
                    cout << "Enter your 3-digit key in capital letters for decryption." << endl;
                        do {
                            ...
                            if (KEY.size() != 3) {
                                cout << "ERRO; Invalid key length! Please try again." << endl;
                            } else {
                                loop = false;
                                ...
                                for (int i = 0; i < 3; i++) {
                                    ...
                                    if (check_n < 65 || check_n > 90) {
                                        cout << "EROOR; Invalid key format! Please try again." << endl;
                                        loop = true;
                                        break;
                                    }
                                }
                    ...
                    cout << "Your decrypted password (Key: " << KEY << ") reads: ";
        ...
        case 3:
            {
                ...
                if (liste->suche(website) != -1) {
                    ...
                    if (passw.size() != 11) {
                        cout << "ERROR; Password must be 11 characters long. Note the format! Return to menu..." << endl;
                        break;
                    } else {
                        ...
                        cout << "ERROR; Format was not entered correctly. Return to menu..." << endl;
                    }
                }
            }
                break;
        ...
        case 5:
            {
                ...
                if (liste->suche(".W") == -1) {
                    ...
                    do {
                        ...
                        if (cin.fail()) {
                            cout << "ERROR; PIN may only consist of numbers! Try again." << endl;
                            cin.clear();
                            cin.sync();
                    ...
                    do {
                        ...
                        if (pin.size() != 4) {
                            cout << "ERROR; PIN must consist of four digits. Try again." << endl;
                        } else if (pin != ad_pin) {
                            cout << "ERROR; Incorrect PIN was entered. Return to menu..." << endl;
                            break_bool = true;
                        }
                    } while(pin.size() != 4);
